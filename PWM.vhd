...
--     CONSTANT c_PWM_CONTROL_REG_INDEX : INTEGER := 1;
--     CONSTANT c_PWM_PRESCALER_REG_INDEX : INTEGER := 2;
--     CONSTANT c_PWM_COUNT_REG_INDEX : INTEGER := 3;
