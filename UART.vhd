...
BEGIN 
    ...
    BEGIN
        ...
        ELSIF(RISING_EDGE(i_Clk)) THEN
            ...
            -- Update RX Done Flag (clear on read)
            -- IF(r_Registers(c_UART_CONTROL_REG_INDEX)(c_UART_CONTROL_REG_RXDONE_BIT) = '1' AND i_Output_Enable = '1' AND w_Address = c_UART_CONTROL_REG_INDEX) THEN
            --     r_Registers(c_UART_CONTROL_REG_INDEX)(c_UART_CONTROL_REG_RXDONE_BIT) <= '0';
            -- ELSIF(r_Registers(c_UART_CONTROL_REG_INDEX)(c_UART_CONTROL_REG_RXDONE_BIT) = '0' AND w_Rx_Done = '1') THEN
